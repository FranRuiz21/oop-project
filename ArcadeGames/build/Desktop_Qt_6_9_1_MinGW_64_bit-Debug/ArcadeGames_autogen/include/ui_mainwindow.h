...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        blackjackButton = new QPushButton(centralwidget);
        blackjackButton->setObjectName("blackjackButton");

        buttonLayout->addWidget(blackjackButton);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        blackjackButton->setText(QCoreApplication::translate("MainWindow", "Blackjack", nullptr));
        (void)MainWindow;
    } // retranslateUi
